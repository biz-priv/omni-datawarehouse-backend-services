...
const tableValues = [
    ...
    { tableName: process.env.SHIPMENT_DESC_TABLE, pKey: "FK_OrderNo", getValues: "FK_OrderNo, Pieces, Weight, ChargableWeight, WeightDimension, Length, Width, Height, DimFactor", sortName: "shipmentDesc" },
