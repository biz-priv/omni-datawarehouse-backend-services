...
const { fetchDataFromTablesList, getUserEmail } = require('../shared/204-payload-generator/helper');
const {
  sendPayload,
  updateOrders,
  liveSendUpdate,
...
async function sendSESEmail({ message, houseBillString, consolNo, userEmail }) {
  try {
    const params = {
      Destination: {
